                ...
                <div class="row">
                    <div>
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active"><a href="?viewtop">Top Jokes</a></li>
                            <li><a href="?viewlatest">Latest Jokes</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-8">
                                                    <br/>
                                                    <a href="#"><?php htmlout($top['name']); ?></a>
                                                    <p class="text-muted"><?php htmlout($top['jokedate']); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">

                                            <p style="background-color: white" class="pull-left"><?php htmlout($top['text']); ?> </p>

                                        </div>
                                        <div class="row">
                                            <div class="col-md-1">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="jokeid" value="<?php htmlout($top['jokeid']); ?>" >
                                                    <?php $test = FALSE; ?>
                                                    <?php foreach ($_SESSION['flag'] as $jid): ?>
                                                        <?php if ($jid == $top['jokeid']): ?>
                                                    ...
                                                    <?php endforeach; ?>
                                                    <?php if ($test == FALSE): ?>
                                                        <input type="submit" name="action1" value="like" class="btn btn-primary btn-xs">
                                                    <?php endif; ?>
                                                </form>
                                            </div>
                                            <div class="col-md-1">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="authorid" value="<?php htmlout($top['authorid']); ?>" >
                                                    <?php $test = FALSE; ?>
                                                    <?php if (isset($friends)): ?>
                                                        <?php foreach ($friends as $friend): ?>
                                                            <?php if ($friend['id'] == $top['authorid']): ?>
                                                                <?php $test = TRUE; ?>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    <?php endif; ?>
                                                    <?php
                                                    if ($_SESSION['id'] == $top['authorid'])
                                                        $test = TRUE;
                                                    ?>
                                                    <?php if ($test == FALSE): ?>
                                                        <input type="submit" name="action1" value="Add" class="btn btn-primary btn-xs">
                                                    <?php endif; ?>
                                                </form>
                                            </div>
                                        </div>
