    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <form class="navbar-form navbar-right" role="search" action="" method="get">
                        ...
                        <a href="#myModal" role="button" data-toggle="modal">Advanced Search</a>
                    </form>
                </div><!--/.nav-collapse -->
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="col-md-2 col-md-offset-1" sidebar>
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <br/>
                        <br/>
                        <a href="?viewuser" class="pull-right"><?php htmlout($username); ?></a>
                    </div>
                </div>
                <br/>
                <br/>
                <div class="row">
                    <div>
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="?viewlatest">Latest Jokers</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-7 col-md-offset-1">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <form role="form" action="?addform" method="post">
                            <div class="form-group">
                                <label for="add_joke"><span class="glyphicon glyphicon-pencil"></span> New Joke</label>
                                <fieldset>
                                    <textarea rows="3" id="add_joke" name="text" class="form-control input-lg"  rows="3" placeholder="What's on your mind?"></textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="col-md-4">
                                                    ...
                                                    $fid = $friend['id'];
                                                    try {
                                                        $sql = 'select path from author where id = :id';
                                                        $s = $pdo->prepare($sql);
                                                        $s->bindValue(':id', $fid);
                                                        $s->execute();
                                                    } catch (Exception $ex) {
                                                ...
                                                <div class="col-md-8">
                                                    <br/>
                                                    <a href="#"><?php htmlout($friend['name']); ?></a>
                                                    <p class="text-muted"><?php htmlout($friend['jokedate']); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">

                                            <p style="background-color: white" class="pull-left"><?php htmlout($friend['text']); ?></p>

                                        </div>
                                        <form action="" method="POST">
                                            <input type="hidden" name="jokeid" value="<?php htmlout($friend['jokeid']); ?>" >
                                            <?php $test = FALSE; ?>
                                            <?php foreach ($_SESSION['flag'] as $jid): ?>
                                                <?php if ($jid == $friend['jokeid']): ?>
                                                    <div class="row">
                                            ...
                                            <?php if ($test == FALSE): ?>
                                                <div class="row">
                                                    <input type="submit" name="action2" class="btn btn-primary btn-sm " value="like" >
                                                </div>
                                            <?php endif; ?>
                                        </form>
