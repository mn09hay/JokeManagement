                ...
                <div class="row">
                    <div>
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active"><a href="#">Find Jokes</a></li>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-8">
                                                    <br/>
                                                    <a href="#"><?php htmlout($joke['name']); ?></a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-1">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="jokeid" value="<?php htmlout($joke['jokeid']); ?>" >
                                                    <?php $test = FALSE; ?>
                                                    <?php foreach ($_SESSION['flag'] as $jid): ?>
                                                        <?php if ($jid == $joke['jokeid']): ?>
                                                    ...
                                                    <?php endforeach; ?>
                                                    <?php if ($test == FALSE): ?>
                                                        <input type="submit" name="action3" value="like" class="btn btn-primary btn-xs">
                                                    <?php endif; ?>
                                                </form>
                                            </div>
                                            <div class="col-md-1">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="authorid" value="<?php htmlout($joke['authorid']); ?>" >
                                                    <?php $test = FALSE; ?>
                                                    <?php if (isset($friends)): ?>
                                                        <?php foreach ($friends as $friend): ?>
                                                            <?php if ($friend['id'] == $joke['authorid']): ?>
                                                                <?php $test = TRUE; ?>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    <?php endif; ?>
                                                    <?php
                                                    if ($_SESSION['id'] == $joke['authorid'])
                                                        $test = TRUE;
                                                    ?>
                                                    <?php if ($test == FALSE): ?>
                                                        <input type="submit" name="action3" value="Add" class="btn btn-primary btn-xs">
                                                    <?php endif; ?>
                                                </form>
                                            </div>
                                        </div>
