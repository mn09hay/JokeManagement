...
<html lang="en">
    ...
    <body>
        <!-- Fixed navbar-->
        <div class="navbar navbar-default navbar-fixed-latest" role="navigation">
            <div class="container">
                ...
                <div class="row">
                    <div>
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="?">News Feed<span class="badge pull-right">42</span></a></li>
                            <li><a href="?viewtop">Top Jokes</a></li>
                            <li class="active"><a href="?viewlatest">Latest Joke</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-8">
                                                    <br/>
                                                    <a href="#"><?php htmlout($latest['name']); ?></a>
                                                    <p class="text-muted"><?php htmlout($latest['jokedate']); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">

                                            <p style="background-color: white" class="pull-left"><?php htmlout($latest['text']); ?> </p>

                                        </div>
                                        <div class="row">
                                            <div class="col-md-1">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="jokeid" value="<?php htmlout($latest['jokeid']); ?>" >
                                                    <?php $test = FALSE; ?>
                                                    ...
                                                    <?php endforeach; ?>
                                                    <?php if ($test == FALSE): ?>
                                                        <input type="submit" name="action2" value="like" class="btn btn-primary btn-xs">
                                                    <?php endif; ?>
                                                </form>
                                            </div>
                                            <div class="col-md-1">
                                                <form action="" method="POST">
                                                    <input type="hidden" name="authorid" value="<?php htmlout($latest['authorid']); ?>" >
                                                    <?php $test = FALSE; ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php
                                                    if ($_SESSION['id'] == $latest['authorid'])
                                                        $test = TRUE;
                                                    ?>
                                                    <?php if ($test == FALSE): ?>
                                                        <input type="submit" name="action2" value="Add" class="btn btn-primary btn-xs">
                                                    <?php endif; ?>
                                                </form>
                                            </div>
                                        </div>
